WSO2 Carbon ${carbon.product.version}
-----------------

${buildNumber}

Welcome to the WSO2 Carbon ${carbon.product.version} release
...
7. Various bug fixes(https://wso2.org/jira/secure/IssueNavigator.jspa?mode=hide&requestId=10814) & enhancements including stabilizing WSO2 Carbon.
...
http://docs.wso2.org/wiki/display/Carbon402/Installation+Prerequisites
