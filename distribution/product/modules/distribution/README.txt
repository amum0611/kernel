...
WSO2 Carbon is the base platform for all WSO2 products. It is a lightweight,
high performing platform which is based on OSGI technology. All
...
----------------------------
1. Embedded Tomcat v7 migration.
2. Transactions support based on Atomikos JTA implementation.
3. Various bug fixes (https://wso2.org/jira/browse/CARBON/fixforversion/xxxxx) and
