...
FOR %%C in ("%CARBON_HOME%\repository\components\plugins\org.wso2.carbon.logging-*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\repository\components\plugins\%%~nC%%~xC"
FOR %%C in ("%CARBON_HOME%\lib\api\org.wso2.carbon.logging-*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\lib\api\%%~nC%%~xC"
FOR %%C in ("%CARBON_HOME%\repository\components\plugins\axiom-*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\repository\components\plugins\%%~nC%%~xC"
FOR %%C in ("%CARBON_HOME%\lib\api\axiom-*.jar") DO set CARBON_CLASSPATH=!CARBON_CLASSPATH!;".\lib\%%~nC%%~xC"
