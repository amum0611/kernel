...
"%JAVA_HOME%\bin\java.exe" -cp %CARBON_CLASSPATH% org.wso2.carbon.core.installer.InstallationManager "uninstall" -java_home "%JAVA_HOME%" -tomcat_home "%CATALINA_HOME%" -jboss_home "%JBOSS_HOME%"  -geronimo_home "%GERONIMO_HOME%"
