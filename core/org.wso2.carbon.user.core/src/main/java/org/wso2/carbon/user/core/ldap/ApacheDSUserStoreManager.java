...
public class ApacheDSUserStoreManager extends LDAPUserStoreManager {
    ...
    private static Log logger = LogFactory.getLog(ApacheDSUserStoreManager.class);
    ...
    private static Log log = LogFactory.getLog(ApacheDSUserStoreManager.class);
    ...
    public ApacheDSUserStoreManager(RealmConfiguration realmConfig,
