...
public interface UserStoreManager extends org.wso2.carbon.user.api.UserStoreManager {
     ...
     * If the realm is not super tenant's this method should throw exception
     * @param username
     * @return
     * @throws UserStoreException
     */
    ...
    /**
     *  Get RoleDTOs which contain the role name and the domain name (if any) of the user store to which the role belongs.
     * @return Array of RoleDTOs
     */
    RoleDTO[] getRoleNamesWithDomain() throws UserStoreException;
