...
public class TenantAxisConfiguration extends AxisConfiguration {
    ...
    public static TenantAxisConfiguration createInstance() {
        ...
        // First build CarbonContext for TenantAxisConfiguration.
        SuperTenantCarbonContext.getCurrentContext(tenantAxisConfiguration);
        // Then initialize it.
    ...
    public void addParameter(Parameter param) throws AxisFault {
        ...
        if (param.getName().equals(MultitenantConstants.LAST_ACCESSED)){
    ...
    public void addParameter(String paramName, Object value) throws AxisFault {
        ...
        if (paramName.equals(MultitenantConstants.LAST_ACCESSED)){
            CarbonUtils.checkSecurity(); 
        }
    ...
    private void checkRestrictedItem(String itemName) {
        if (restrictedItems.containsKey(itemName)) {
            ...
            if (isSet) {
                int tenantId = SuperTenantCarbonContext.getCurrentContext(this).getTenantId();
                String tenantDomain = SuperTenantCarbonContext.getCurrentContext(this).getTenantDomain();
