...
public class TenantAxisConfiguration extends AxisConfiguration {
    ...
    public static TenantAxisConfiguration createInstance() {
        ...
        PrivilegedCarbonContext.getCurrentContext(tenantAxisConfiguration);
        // Then initialize it.
    ...
    private void checkRestrictedItem(String itemName) {
        if (restrictedItems.containsKey(itemName)) {
            ...
            if (isSet) {
                int tenantId = PrivilegedCarbonContext.getCurrentContext(this).getTenantId();
                String tenantDomain = PrivilegedCarbonContext.getCurrentContext(this).getTenantDomain();
