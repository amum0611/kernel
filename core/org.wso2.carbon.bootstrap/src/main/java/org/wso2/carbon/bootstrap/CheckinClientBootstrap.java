...
public class CheckinClientBootstrap extends Bootstrap {
    ...
    protected void addClassPathEntries() throws MalformedURLException {
        super.addClassPathEntries();    //To change body of overridden methods use File | Settings | File Templates.

        // lib/core/WEB-INF/lib
        addFileUrl(new File(ROOT + File.separator + "lib" + File.separator + "core" + File.separator + "WEB-INF" +
                File.separator + "lib" + File.separator));
        addJarFileUrls(new File(ROOT + File.separator + "lib" + File.separator + "core" + File.separator + "WEB-INF" +
                File.separator + "lib"));
        ...
        addFileUrl(new File(ROOT + File.separator + "repository" + File.separator + "components" + File.separator +
                "plugins" + File.separator));
        addJarFileUrls(new File(ROOT + File.separator + "repository" + File.separator + "components" + File.separator +
                "plugins"));
        ...
        addFileUrl(new File(ROOT + File.separator + "lib" + File.separator + "checkin-client" + File.separator +
                "log4j.properties"));
