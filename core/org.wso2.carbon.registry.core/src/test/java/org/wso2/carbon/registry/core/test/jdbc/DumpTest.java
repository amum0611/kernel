...
public class DumpTest extends BaseTestCase {
    ...
    public void testRootRestore() throws RegistryException, XMLStreamException {
        ...
        registry.put("/testSomewhereElse", r);

        // adding children
        Resource r1 = registry.newCollection();
        r1.setProperty("key1", "value1C");
        r1.setProperty("key2", "value2C");
        registry.put("/testSomewhereElse/child1CY", r1);

        Resource r2 = registry.newResource();
        r2.setContent("content child2R");
        registry.put("/testSomewhereElse/child2RY", r2);

        registry.addComment("/testSomewhereElse", new Comment("comment3"));
        registry.addComment("/testSomewhereElse", new Comment("comment4"));

        registry.applyTag("/testSomewhereElse", "tag3");
        registry.applyTag("/testSomewhereElse", "tag4");

        registry.rateResource("/testSomewhereElse", 2);

        // doing the dump
        StringWriter writer = new StringWriter();
        registry.dump("/testSomewhereElse", writer);
        Reader input = new StringReader(writer.toString());
    ...
    public void testSimpleNewRestore() throws RegistryException, XMLStreamException {
        ...
        r1.setProperty("key1", "value1C");
        r1.setProperty("key2", "value2C");
        registry.put("/testSomewhereElse/child1CY/foo", r1);
    ...
    public void testNewRestore() throws RegistryException, XMLStreamException {
        ...
        r1.setProperty("key1", "value1C");
        r1.setProperty("key2", "value2C");
        registry.put("/testSomewhereElse/child1CY/bar", r1);

        Resource r2 = registry.newCollection();
        //r2.setContent("content child2R");
        registry.put("/testSomewhereElse/newWWC1", r2);

        r2 = registry.newCollection();
        //r2.setContent("content child2R");
        registry.put("/testSomewhereElse/newWWC2", r2);
