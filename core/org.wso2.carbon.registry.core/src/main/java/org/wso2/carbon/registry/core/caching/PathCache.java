...
public class PathCache {
     ...
     * The path cache.
     */
    protected static final Cache PATH_CACHE =
            RegistryUtils.getCommonCache(RegistryConstants.PATH_CACHE_ID);
    ...
    public double hitRate() {
        CacheStatistics stats = PATH_CACHE.getCacheStatistics();
