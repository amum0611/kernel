...
public class JDBCResourceDAO implements ResourceDAO {
    ...
    public void addResource(ResourceImpl resourceImpl, boolean isUpdatingExisting)
            throws RegistryException {
        ...
        try {
            ...
            ps.setString(8, resourceImpl.getDescription());
            if (resourceImpl.getDbBasedContentID() > 0) {
                ps.setInt(9, resourceImpl.getDbBasedContentID());
            } else {
    ...
    public void addResourceWithNoUpdate(ResourceImpl resourceImpl)
        ...
        try {
            ...
            ps.setString(2, resourceID.getName());
            ps.setString(3, resourceImpl.getMediaType());
            ps.setString(4, resourceImpl.getAuthorUserName());

            Date createdTime = resourceImpl.getCreatedTime();
            ps.setTimestamp(5, new Timestamp(createdTime.getTime()));

            ps.setString(6, resourceImpl.getLastUpdaterUserName());

            Date updatedTime = resourceImpl.getLastModified();
            ps.setTimestamp(7, new Timestamp(updatedTime.getTime()));
