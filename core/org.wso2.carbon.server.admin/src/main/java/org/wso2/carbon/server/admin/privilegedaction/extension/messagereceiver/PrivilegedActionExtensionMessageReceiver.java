...
public class PrivilegedActionExtensionMessageReceiver extends
                                                      RPCMessageReceiver {

	private static final Log log = LogFactory
			.getLog(PrivilegedActionExtensionMessageReceiver.class);
	...
	public void invokeBusinessLogic(MessageContext inMsgCtx,
		...
		try {
			extensions = PrivilegedActionExtensionRegistry
					.getPrivilegedActionExtensions(inMsgCtx);
