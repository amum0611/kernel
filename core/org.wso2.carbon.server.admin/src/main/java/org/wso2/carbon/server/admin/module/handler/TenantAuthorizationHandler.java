...
public class TenantAuthorizationHandler extends AbstractHandler {
    ...
    public InvocationResponse invoke(MessageContext msgContext) throws AxisFault {
        ...
        int tenantId = PrivilegedCarbonContext.getCurrentContext(msgContext).getTenantId();
        ...
        if (tenantId != MultitenantConstants.SUPER_TENANT_ID) {
            ...
            message.append(axisService.getName()).append(" operation - ").append(axisOperation.getName())
                    ...
                    .append(PrivilegedCarbonContext.getCurrentContext(msgContext).getTenantDomain(false))
