...
public class PrivilegedActionExtensionRegistry {
	...
	private static Log log = LogFactory
			.getLog(PrivilegedActionExtensionRegistry.class);
	private static ServiceTracker extensionTracker;

	public static void init(BundleContext bc) throws Exception {
		try {
			extensionTracker = new ServiceTracker(bc,
					PrivilegedActionExtension.class.getName(), null);
	...
	public static ArrayList<PrivilegedActionExtension> getPrivilegedActionExtensions(
			MessageContext msgContext)
			throws PrivilegedActionExtensionException {

		Object[] objects = extensionTracker.getServices();

		if (objects == null) {
			throw new PrivilegedActionExtensionException(
