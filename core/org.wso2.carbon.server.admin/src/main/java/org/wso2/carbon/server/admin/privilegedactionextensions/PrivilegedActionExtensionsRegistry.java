...
public class PrivilegedActionExtensionsRegistry {

	private static Log log = LogFactory.getLog(PrivilegedActionExtensionsRegistry.class);
	...
	public static ArrayList<PrivilegedActionExtension> getPrivilegedActionExtensions(MessageContext msgContext)
		...
		if (objects == null) {
			throw new PrivilegedActionException("No extension found for the action");
		}
		...
		Collections.sort(extensions, new PrivilegedActionExtensionsComparator());
