...
<%
    ...
    String featureVersion = request.getParameter("featureVersion");
    String divIDToShow = request.getParameter("divIDToShow");
    String divIDToHide = request.getParameter("divIDToHide");
    String tabNumber = request.getParameter("tabNumber");
    boolean isInstalledFeature = Boolean.parseBoolean(request.getParameter("isInstalledFeature"));
