...
public class ServiceHolder {
    private static final String P2_AGENT_LOCATION = System.getProperty("carbon.home") + 
    ...
    private static URI getAgentURI(String path) {
    	...
    	try {
    		...
    		uri = file.getCanonicalFile().toURI(); //file paths in windows are different from canonical path
      ...
      ServiceHolder.provisioningAgentProvider = provisioningAgentProvider;
        if(ServiceHolder.provisioningAgentProvider != null){
            ...
            try {
                ...
                //System.out.println("provision Exception occurred");
            ...
            setP2Engine(engine);
                ...
                provisioningAgent.registerService("eclipse.p2.profile", "WSO2CarbonProfile");
                try {
