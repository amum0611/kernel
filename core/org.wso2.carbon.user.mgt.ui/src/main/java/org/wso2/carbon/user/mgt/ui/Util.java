...
public class Util {
    ...
    public static org.wso2.carbon.user.mgt.common.FlaggedName[] toCommonFlaggedNames(
        ...
        for (FlaggedName fName : flaggedNames) {
            ...
            name.setDomainName(fName.getDomainName());	
            names[i] = name;
            i++;
        }
        return names;
    ...
    public static org.wso2.carbon.user.mgt.common.UserStoreInfo toCommonUserStoreInfo(
        ...
        usInfo.setUserClaims(userStoreInfo.getUserClaims());
        usInfo.setRequiredUserClaims(userStoreInfo.getRequiredUserClaims());
        return usInfo;
    }
