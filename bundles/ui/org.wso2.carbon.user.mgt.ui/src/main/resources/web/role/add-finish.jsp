...
<%
        roleName = CharacterEncoder.getSafeText(((RoleBean)session.getAttribute("roleBean")).getRoleName());
        ...
        proxy.addRole(((RoleBean)session.getAttribute("roleBean")).getRoleName(), ((RoleBean)session.getAttribute("roleBean")).getSelectedUsers(), ((RoleBean)session.getAttribute("roleBean")).getSelectedPermissions());
