...
<carbon:breadcrumb label="select.roles" resourceBundle="org.wso2.carbon.userstore.ui.i18n.Resources" topPage="false" request="<%=request%>"/>
    <%
        ...
        boolean hasMultipleUserStores = proxy.hasMultipleUserStores();
                                     ...
                                     <td>
                                        <table class="normal" id="rolesTableId">
                                            ...
                                            %>
                                                <tr>
                                                <td>
                                                    <input type="checkbox" name="userRoles" value="<%=data.getItemName()%>" <%=checked%> />
                                                    <%=CharacterEncoder.getSafeText(data.getItemName())%>
                                                </td>
                                                <%if(hasMultipleUserStores){%>
							                    	<td><%=CharacterEncoder.getSafeText(data.getDomainName())%></td>
							                    <%}%>
                                            </tr>
                                            <%
                                                        }
