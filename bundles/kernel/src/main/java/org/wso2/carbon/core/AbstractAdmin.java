...
public abstract class AbstractAdmin {
    ...
    protected ConfigurationContext getConfigContext() {
        ...
        if (msgContext != null) {
            ...
            PrivilegedCarbonContext carbonContext = PrivilegedCarbonContext.getCurrentContext(msgContext);
    ...
    protected Registry getConfigSystemRegistry() {
        return (Registry) PrivilegedCarbonContext.getCurrentContext(getAxisConfig()).
    ...
    protected Registry getLocalRepo() {
        return (Registry) PrivilegedCarbonContext.getCurrentContext(getAxisConfig()).getRegistry(
