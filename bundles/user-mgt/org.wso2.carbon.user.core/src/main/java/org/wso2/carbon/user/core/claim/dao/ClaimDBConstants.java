...
public final class ClaimDBConstants {
        ...
        public static final String ADD_CLAIM_SQL = "INSERT INTO UM_CLAIM(UM_DIALECT_ID, UM_CLAIM_URI, " +
                ...
                "UM_SUPPORTED, UM_REQUIRED, UM_DISPLAY_ORDER, UM_TENANT_ID) VALUES (?,?,?,?,?,?,?,?,?,?)";
        public static final String UPDATE_CLAIM_SQL = "UPDATE UM_CLAIM SET UM_DISPLAY_TAG=?, UM_DESCRIPTION=?, " +
                "UM_MAPPED_ATTRIBUTE=?, UM_REG_EX=?, UM_SUPPORTED=?, UM_REQUIRED=?, UM_DISPLAY_ORDER=? " +
                "WHERE UM_CLAIM.UM_CLAIM_URI=? AND UM_DIALECT_ID=(SELECT UM_ID FROM UM_DIALECT WHERE " +
        ...
        public static final String ON_CLAIM_DELETE_REMOVE_BEHAVIOR = "DELETE FROM UM_CLAIM_BEHAVIOR " +
                "WHERE UM_CLAIM_ID=(SELECT UM_ID FROM UM_CLAIM WHERE UM_CLAIM_URI=? AND " +
                "UM_DIALECT_ID=(SELECT UM_ID FROM UM_DIALECT WHERE UM_DIALECT_URI=? AND " +
